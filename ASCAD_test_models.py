...
def read_parameters_from_file(param_filename):
	...
	return model_file, ascad_database, num_traces, target_byte, multilabel, simulated_key, save_file, nvidia_bugfix
...
if __name__ == "__main__":
	if len(sys.argv)!=2:
		...
		model_file, ascad_database, num_traces, target_byte, multilabel, simulated_key, save_file, nvidia_bugfix  = read_parameters_from_file(sys.argv[1])
	if (nvidia_bugfix == 1):
